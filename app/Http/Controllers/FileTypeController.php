...
class FileTypeController extends AppBaseController
{
    ...
    {
        $this->isSuperAdmin();
        return $fileTypeDataTable->render('metronic.file_types.index');
    }
    ...
    {
        $this->isSuperAdmin();
        return view('metronic.file_types.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('metronic.file_types.show')->with('fileType', $fileType);
    }
    ...
    public function edit($id)
    {
        ...
        return view('metronic.file_types.edit')->with('fileType', $fileType);
    }
