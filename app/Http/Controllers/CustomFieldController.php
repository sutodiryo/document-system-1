...
class CustomFieldController extends AppBaseController
{
    ...
    {
        $this->isSuperAdmin();
        return $customFieldDataTable->render('metronic.custom_fields.index');
    }
    ...
    {
        $this->isSuperAdmin();
        return view('metronic.custom_fields.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('metronic.custom_fields.show')->with('customField', $customField);
    }
    ...
    public function edit($id)
    {
        ...
        return view('metronic.custom_fields.edit')->with('customField', $customField);
    }
