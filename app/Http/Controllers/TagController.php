...
class TagController extends AppBaseController
{
    ...
    public function index(TagDataTable $tagDataTable)
    {
        ...
        return $tagDataTable->render('metronic.tags.index');
    }
    ...
    public function create()
    {
        ...
        return view('metronic.tags.create', compact('customFields'));
    }
    ...
    public function show($id)
    {
        ...
        return view('metronic.tags.show', compact('tag', 'tagWisePermList', 'globalPermissionUsers'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('metronic.tags.edit')->with('tag', $tag)->with('customFields', $customFields);
    }
