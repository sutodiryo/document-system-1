...
class SettingController extends AppBaseController
{
    ...
    {
        $this->isSuperAdmin();
        return $settingDataTable->render('metronic.settings.index');
    }
    ...
    {
        abort(404);
        return view('metronic.settings.create');
    }
    ...
    public function store(CreateSettingRequest $request)
    {
        ...
        return redirect(route('metronic.settings.index'));
    }
    ...
    public function show($id)
    {
        ...
        return view('metronic.settings.show')->with('setting', $setting);
    }
    ...
    public function edit($id)
    {
        ...
        return view('metronic.settings.edit')->with('setting', $setting);
    }
