...
class UserController extends AppBaseController
{
    ...
    public function index(UserDataTable $userDataTable)
    {
        ...
        return $userDataTable->render('metronic.users.index');
    }
    ...
    public function create()
    {
        ...
        return view('metronic.users.create', compact('tags'));
    }
    ...
    public function show($id)
    {
        ...
        return view('metronic.users.show', compact('user', 'tags', 'documents','globalPermissions'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('metronic.users.edit')->with('user', $user)->with('tags', $tags);
    }
