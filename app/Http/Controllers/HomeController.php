...
class HomeController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('metronic.home',compact('documents','activities','tagCounts','documentCounts','filesCounts'));
    }
    ...
    public function welcome()
    {
        ...
        return view('metronic.welcome',compact('quotes'));
    }
    ...
    public function profile(UpdateProfileRequest $request)
    {
        ...
        return view('metronic.profile',compact('profile'));
    }
    ...
    public function downloadPdf(Request $request)
    {
        ...
        $pdf = PDF::loadView('metronic.pdf', compact('docName','filePaths'));
