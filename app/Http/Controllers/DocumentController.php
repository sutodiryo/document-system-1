...
class DocumentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('metronic.documents.index', compact('folders', 'documents', 'tags'));
    }
    ...
    public function create()
    {
        ...
        return view('metronic.documents.create', compact('tags', 'customFields'));
    }
    ...
    public function storeFolder(Request $request)
    {
        ...
        if (!$request->id) {
            ...
            return redirect()->route('documents', ['id' => 1]);
        }
    }
    ...
    {
        $lock = Document::find($request->id)->update(['lock_status' => 1]);
        return redirect()->route('documents.show', $request->id);
    }

    public function unlock(Request $request)
    {
        $lock = Document::find($request->id)->update(['lock_status' => 0]);
        return redirect()->route('documents.show', $request->id);
    }
    ...
    public function edit($id)
    {
        ...
        $tags = Tag::all();
        $customFields = $this->customFieldRepository->getForModel('documents');
        return view('metronic.documents.edit', compact('tags', 'customFields', 'document'));
    }
    ...
    public function showUploadFilesUi($id)
    {
        ...
        return view('metronic.documents.file_upload', compact('document', 'fileTypes', 'customFields'));
    }
