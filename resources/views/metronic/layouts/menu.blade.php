            ...
            <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper">
                ...
                <div id="kt_app_sidebar_menu_scroll" class="scroll-y my-5 mx-3" data-kt-scroll="true"
                    ...
                    <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6"
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{ Request::is('admin/home*') ? 'active' : '' }}"
                        ...
                        @can('viewAny', \App\Document::class)
                            <div class="menu-item">
                                <a class="menu-link {{ Request::is('admin/documents*') ? 'active' : '' }}"
                                    ...
                                    <span class="menu-title">{{ ucfirst(config('settings.document_label_plural')) }}</span>
                                </a>
                            </div>
                        @endcan

                        @if (auth()->user()->is_super_admin)
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ Request::is('admin/advanced*') ? 'show' : '' }}">
